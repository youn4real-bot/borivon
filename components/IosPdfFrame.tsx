...
export function IosPdfFrame({
  ...
  // Blob URLs (URL.createObjectURL output) don't take a query-string cache-bust
  // — the browser looks them up by exact UUID-path match. Skip ?_v= for blobs;
  // each new blob URL is unique already so caching is moot.
