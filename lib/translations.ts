...
export const translations: Record<Lang, Translation> = {
  fr: {
    ...
    pWizardPhase2: "Documents", pWizardPhase2Desc: "Vos diplômes, attestations de formation et expérience professionnelle.",
    ...
    pOriginalsOnlyShort: "Traducteurs assermentés acceptés :",
    ...
    adOrgNeeds: "Besoins agence", adAnySpecialty: "Toute spécialité", adSlot: "place", adSlots: "places",
    ...
    adAcceptHint: "Accepter — lie le candidat à l'agence", adAccept: "Accepter",
    adSkipHint: "Ignorer — retire de la boîte de réception",
    adSelectOrg: "Sélectionner une agence…", adAdd: "Ajouter", adNoActiveReqs: "Aucun besoin actif",
  ...
  en: {
    ...
    pWizardPhase2: "Documents", pWizardPhase2Desc: "Your diplomas, training documents and professional experience.",
    ...
    pOriginalsOnlyShort: "Accepted sworn translators:",
    ...
    adOrgNeeds: "Agency needs", adAnySpecialty: "Any specialty", adSlot: "slot", adSlots: "slots",
    ...
    adAcceptHint: "Accept — links candidate to agency", adAccept: "Accept",
    adSkipHint: "Skip — removes from inbox",
    adSelectOrg: "Select agency…", adAdd: "Add", adNoActiveReqs: "No active requirements yet",
  ...
  de: {
    ...
    pTypeWorkcertDE: "Berufserlaubnis (DE)",
    ...
    pTypeImpfung: "Impfung",
    pTypeImpfungDE: "Impfung (DE)",
    ...
    pWizardPhase2: "Unterlagen", pWizardPhase2Desc: "Ihre Diplome, Ausbildungsnachweise und Berufserfahrung.",
    ...
    pOriginalsOnlyShort: "Akzeptierte vereidigte Übersetzer:",
    ...
    pGuideWorkTitle: "So erhalten Sie die Berufserlaubnis für Krankenpflege",
    ...
    adOrgNeeds: "Agentur-Bedarf", adAnySpecialty: "Beliebige Fachrichtung", adSlot: "Platz", adSlots: "Plätze",
    ...
    adAcceptHint: "Annehmen — verknüpft Kandidat mit Agentur", adAccept: "Annehmen",
    adSkipHint: "Überspringen — entfernt aus dem Posteingang",
    adSelectOrg: "Agentur wählen…", adAdd: "Hinzufügen", adNoActiveReqs: "Noch keine aktiven Anforderungen",
