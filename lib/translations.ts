...
export const translations: Record<Lang, Translation> = {
  ...
  de: {
    ...
    pWizardPhase1: "Wesentliches", pWizardPhase1Desc: "Hauptdokumente zum Starten Ihrer Bewerbung.",
    ...
    pSideID: "Wesentliches", pSideNursing: "Unterlagen", pSideTrans: "Übersetz.", pSideOther: "Sonstiges",
