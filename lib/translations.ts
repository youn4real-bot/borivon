...
export const translations: Record<Lang, Translation> = {
  fr: {
    ...
    pWizardPhase2: "Qualifications infirmières 🏥", pWizardPhase2Desc: "Vos diplômes, attestations de formation et expérience en soins infirmiers.",
    ...
    pOriginalsOnlyShort: "Originaux uniquement — traductions à l'étape suivante.",
  ...
  en: {
    ...
    pWizardPhase2: "Nursing Qualifications 🏥", pWizardPhase2Desc: "Your diplomas, training documents and nursing work experience.",
    ...
    pSideID: "Essentials", pSideNursing: "Nursing", pSideTrans: "Translations", pSideOther: "Others",
    ...
    pOriginalsOnlyShort: "Originals only — translations in the next step.",
  ...
  de: {
    ...
    pWizardPhase2: "Pflegequalifikationen 🏥", pWizardPhase2Desc: "Ihre Diplome, Ausbildungsnachweise und Berufserfahrung in der Pflege.",
    ...
    pSideID: "Essentielles", pSideNursing: "Pflege", pSideTrans: "Übersetz.", pSideOther: "Sonstiges",
    ...
    pOriginalsOnlyShort: "Nur Originale — Übersetzungen im nächsten Schritt.",
