...
export const translations: Record<Lang, Translation> = {
  ...
  de: {
    ...
    pTypeAbitur: "Abitur", pTypeAbiturTranscript: "Abitur Übersicht", pTypePraktikum: "Ausbildungspraktikum",
    pTypeCVde: "Lebenslauf (DE)", pTypeDiplomaDE: "Diplom (DE)",
    pTypeStudyProgDE: "Ausbildungsprogramm (DE)", pTypeTranscriptDE: "Notenübersicht (DE)",
    pTypeAbiturDE: "Abitur (DE)", pTypeAbiturTranscriptDE: "Abitur Übersicht (DE)", pTypePraktikumDE: "Ausbildungspraktikum (DE)",
