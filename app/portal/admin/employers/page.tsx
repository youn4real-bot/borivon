...
export default function AdminEmployersPage() {
  ...
  const L = lang === "fr"
    ? {
        ...
        noOrgs: "Pas encore d'agences. Créez-en une sous Agences.",
    ...
    ? {
        ...
        noOrgs: "Noch keine Agenturen. Lege eine unter Agenturen an.",
    ...
    : {
        ...
        noOrgs: "No agencies yet. Create one under Agencies.",
