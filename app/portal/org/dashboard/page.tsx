...
const t = {
  en: {
    ...
    oncWeMatch: "Once we match a candidate to your agency, they'll appear here.",
  ...
  fr: {
    ...
    oncWeMatch: "Dès qu'un candidat est associé à votre agence, il apparaîtra ici.",
  ...
  de: {
    ...
    oncWeMatch: "Sobald wir einen Kandidaten Ihrer Agentur zuordnen, erscheint er hier.",
