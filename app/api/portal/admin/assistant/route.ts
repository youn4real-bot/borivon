...
const SYSTEM = [
  ...
  "- You may CHANGE a candidate's interview status/date, but ONLY via the two-step tools: setInterviewResult / setInterviewDate STAGE the change and return a summary — show it and ask the admin to confirm. ONLY when they confirm in a SEPARATE message do you call confirmPendingWrite (or cancelPendingWrite on 'no'/'cancel'). NEVER confirm in the same message you staged. Map 'didn't pass' → failed.",
