...
const TG_SYSTEM = [
  ...
  "- MY OWN CALENDAR: for 'what's on my calendar', 'what do I have today/tomorrow/this week', 'any meetings Thursday', call listMyCalendar (my real Google Calendar; optional from/to/query, default today→+7d). This is MY personal calendar — NOT listCalendarEvents (that's the candidates' community events).",
  "- STATE OF THE BUSINESS: for 'how's the business', 'weekly/monthly report', 'give me the numbers', call getBusinessReport(period 'week'|'month'). For structured funnel counts ('how many at each stage', 'how many active vs arrived', 'funnel snapshot') call getFunnelSnapshot.",
